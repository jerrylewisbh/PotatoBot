...
from functions.top import top_about, attack_top, def_top, exp_top, week_build_top, week_battle_top, squad_top
...
def add_handler(disp: Dispatcher):
    ...
    disp.add_handler(RegexHandler(to_re(TOP_COMMAND_SQUAD), squad_top))
